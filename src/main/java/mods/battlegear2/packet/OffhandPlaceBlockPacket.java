...
public final class OffhandPlaceBlockPacket extends AbstractMBPacket {
    ...
    public void process(ByteBuf in, EntityPlayer player) {
        ...
        if (offhandWeapon != null && !BattlegearUtils.usagePriorAttack(offhandWeapon)) return;
        boolean flag = true;
        int i = xPosition;
        int j = yPosition;
        int k = zPosition;
        ...
        if (offhandWeapon != null && BattlemodeHookContainerClass.isItemBlock(offhandWeapon.getItem())) {
            ...
            if (offhandWeapon == null || offhandWeapon.getMaxItemUseDuration() == 0) {
                ...
                BattlegearUtils
                    .setPlayerOffhandItem(player, ItemStack.copyItemStack(BattlegearUtils.getOffhandItem(player)));
